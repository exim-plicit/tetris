...
export class Field {
	...
	setMino(type, dir, x, y){
		...
		switch(type){
			...
			case 1:{
				switch(dir){
					case 0: setData(x+0,y+0); setData(x+1,y+0); setData(x+0,y+1); setData(x+1,y+1); break;
				}
			}break;
			//I mino
			case 2:{
				switch(dir){
					case 0: setData(x+0,y+0); setData(x+1,y+0); setData(x+2,y+0); setData(x+3,y+0); break;
					case 1: setData(x+0,y+0); setData(x+0,y+1); setData(x+0,y+2); setData(x+0,y+3); break;
				}
			}break;
			//T mino
			case 3:{
				switch(dir){
					case 0: setData(x+0,y+0); setData(x+1,y+0); setData(x+2,y+0); setData(x+1,y+1); break;
					case 1: setData(x+0,y+0); setData(x+0,y+1); setData(x+0,y+2); setData(x+1,y+1); break;
					case 2: setData(x+1,y+0); setData(x+0,y+1); setData(x+1,y+1); setData(x+2,y+1); break;
					case 3: setData(x+0,y+1); setData(x+1,y+0); setData(x+1,y+1); setData(x+1,y+2); break;
				}
			}break;
			//L mino
			case 4:{
				switch(dir){
					case 0: setData(x+0,y+0); setData(x+1,y+0); setData(x+2,y+0); setData(x+2,y+1); break;
					case 1: setData(x+0,y+0); setData(x+0,y+1); setData(x+0,y+2); setData(x+1,y+0); break;
					case 2: setData(x+0,y+0); setData(x+0,y+1); setData(x+1,y+1); setData(x+2,y+1); break;
					case 3: setData(x+0,y+2); setData(x+1,y+0); setData(x+1,y+1); setData(x+1,y+2); break;
				}
			}break;
			//J mino
			case 5:{
				switch(dir){
					case 0: setData(x+0,y+0); setData(x+1,y+0); setData(x+2,y+0); setData(x+0,y+1); break;
					case 1: setData(x+0,y+0); setData(x+0,y+1); setData(x+0,y+2); setData(x+1,y+2); break;
					case 2: setData(x+2,y+0); setData(x+0,y+1); setData(x+1,y+1); setData(x+2,y+1); break;
					case 3: setData(x+0,y+0); setData(x+1,y+0); setData(x+1,y+1); setData(x+1,y+2); break;
				}
			}break;
			//S mino
			case 6:{
				switch(dir){
					case 0: setData(x+0,y+0); setData(x+1,y+0); setData(x+1,y+1); setData(x+2,y+1); break;
					case 1: setData(x+1,y+0); setData(x+0,y+1); setData(x+1,y+1); setData(x+0,y+2); break;
				}
			}break;
			//Z mino
			case 7:{
				switch(dir){
					case 0: setData(x+1,y+0); setData(x+2,y+0); setData(x+0,y+1); setData(x+1,y+1); break;
					case 1: setData(x+0,y+0); setData(x+0,y+1); setData(x+1,y+1); setData(x+1,y+2); break;
				}
			}break;
		}
	}
		...
		for(let y = 0 ; y < this.height ; ++y){
			for(let x = 0 ; x < this.width ; ++x){
				const isLink = (myno,ix,iy)=>{
					if(myno == Number.MAX_SAFE_INTEGER) return true;
				...
				let [type,no] = DATA2STRUCT(data(ix,iy));

				const color_frame = new Color()
				const color_inner = new Color()
				//色決定
				if(type==0 && no==0){
					color_frame.set( 16, 16, 16);
					color_inner.set(  0,  0,  0);
				}else{
					switch(type){
					...
					/*
					if(type != 0){
						const round = Math.trunc((this.setNum-1) / 7);
						//if(no <= round*7){
						if(no > 7){
							color_frame.set(0, 0, 0);
							color_inner.set(64, 64, 64);
				...
				if(no != 0){
					if(sx==0 || sx==N || sy==0 || sy==N){
						color.set((color_inner.r*2+color_frame.r)/3,(color_inner.g*2+color_frame.g)/3,(color_inner.b*2+color_frame.b)/3);
					}
					//seed値を持っていたら接続判定を行う
